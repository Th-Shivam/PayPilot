...
import { PayPilotMark } from '../components/auth/PayPilotMark'
import {
  ApiClientError,
  getAnalytics,
  getTickets,
...
function SidebarContents({ role, activeView, exceptionCount, onRoleChange, onNavigate, onSignOut }: { role: Role; activeView: DashboardView; exceptionCount: number; onRoleChange: (role: Role) => void; onNavigate: (view: DashboardView) => void; onSignOut: () => void }): ReactElement {
